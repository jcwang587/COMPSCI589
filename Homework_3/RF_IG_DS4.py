...
if __name__ == '__main__':
    ...
    list_target = df[9].unique()
    df2 = df[df[9].isin([list_target[0]])]
    df1 = df[df[9].isin([list_target[1]])]
    df0 = df[df[9].isin([list_target[2]])]
    # Split into folds
    kfold = []
