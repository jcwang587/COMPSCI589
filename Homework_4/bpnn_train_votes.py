    ...
    for ai in architecture:
        ...
        while fold_idx < 10:
            try:
                ...
                # Calculate metrics
                accuracy.append(accuracy_score(final_true, final_prediction))
                precision.append(precision_score(final_true, final_prediction))
                recall.append(recall_score(final_true, final_prediction))
